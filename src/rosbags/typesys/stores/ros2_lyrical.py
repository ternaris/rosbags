...
from . import ros2_kilted as base
...
geometry_msgs__msg__PolygonInstance = base.geometry_msgs__msg__PolygonInstance
geometry_msgs__msg__PolygonInstanceStamped = base.geometry_msgs__msg__PolygonInstanceStamped
...
geometry_msgs__msg__VelocityStamped = base.geometry_msgs__msg__VelocityStamped
...
nav_msgs__msg__Goals = base.nav_msgs__msg__Goals
...
rcl_interfaces__msg__LoggerLevel = base.rcl_interfaces__msg__LoggerLevel
...
rcl_interfaces__msg__SetLoggerLevelsResult = base.rcl_interfaces__msg__SetLoggerLevelsResult
...
service_msgs__msg__ServiceEventInfo = base.service_msgs__msg__ServiceEventInfo
...
type_description_interfaces__msg__Field = base.type_description_interfaces__msg__Field
type_description_interfaces__msg__FieldType = base.type_description_interfaces__msg__FieldType
type_description_interfaces__msg__IndividualTypeDescription = (
    base.type_description_interfaces__msg__IndividualTypeDescription
)
type_description_interfaces__msg__KeyValue = base.type_description_interfaces__msg__KeyValue
type_description_interfaces__msg__TypeDescription = (
    base.type_description_interfaces__msg__TypeDescription
)
type_description_interfaces__msg__TypeSource = base.type_description_interfaces__msg__TypeSource
...
@dataclass
class rosbag2_interfaces__msg__MessagesLostEvent:
    """Class for rosbag2_interfaces/msg/MessagesLostEvent."""

    node_name: str
    messages_lost_statistics: list[rosbag2_interfaces__msg__MessagesLostEventTopicStat]
    __msgtype__: ClassVar[str] = 'rosbag2_interfaces/msg/MessagesLostEvent'


@dataclass
class rosbag2_interfaces__msg__MessagesLostEventTopicStat:
    """Class for rosbag2_interfaces/msg/MessagesLostEventTopicStat."""

    topic_name: str
    messages_lost_in_transport: int
    messages_lost_in_recorder: int
    __msgtype__: ClassVar[str] = 'rosbag2_interfaces/msg/MessagesLostEventTopicStat'


@dataclass
class rosgraph_msgs__msg__Action:
    """Class for rosgraph_msgs/msg/Action."""

    name: str
    send_goal: rosgraph_msgs__msg__Service
    get_result: rosgraph_msgs__msg__Service
    cancel_goal: rosgraph_msgs__msg__Service
    feedback: rosgraph_msgs__msg__Topic
    status: rosgraph_msgs__msg__Topic
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/Action'


@dataclass
class rosgraph_msgs__msg__Graph:
    """Class for rosgraph_msgs/msg/Graph."""

    nodes: list[rosgraph_msgs__msg__Node]
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/Graph'


@dataclass
class rosgraph_msgs__msg__InterfaceType:
    """Class for rosgraph_msgs/msg/InterfaceType."""

    name: str
    hash: rosgraph_msgs__msg__TypeHash
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/InterfaceType'


@dataclass
class rosgraph_msgs__msg__Node:
    """Class for rosgraph_msgs/msg/Node."""

    name: str
    parameters: list[rcl_interfaces__msg__ParameterDescriptor]
    parameter_values: list[rcl_interfaces__msg__ParameterValue]
    publishers: list[rosgraph_msgs__msg__Topic]
    subscriptions: list[rosgraph_msgs__msg__Topic]
    service_clients: list[rosgraph_msgs__msg__Service]
    service_servers: list[rosgraph_msgs__msg__Service]
    action_clients: list[rosgraph_msgs__msg__Action]
    action_servers: list[rosgraph_msgs__msg__Action]
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/Node'


@dataclass
class rosgraph_msgs__msg__QoSProfile:
    """Class for rosgraph_msgs/msg/QoSProfile."""

    depth: int
    deadline: builtin_interfaces__msg__Duration
    lifespan: builtin_interfaces__msg__Duration
    history: int
    reliability: int
    durability: int
    liveliness: int
    liveliness_lease_duration: builtin_interfaces__msg__Duration
    HISTORY_SYSTEM_DEFAULT: ClassVar[int] = 0
    HISTORY_KEEP_LAST: ClassVar[int] = 1
    HISTORY_KEEP_ALL: ClassVar[int] = 2
    HISTORY_UNKNOWN: ClassVar[int] = 3
    RELIABILITY_SYSTEM_DEFAULT: ClassVar[int] = 0
    RELIABILITY_RELIABLE: ClassVar[int] = 1
    RELIABILITY_BEST_EFFORT: ClassVar[int] = 2
    RELIABILITY_UNKNOWN: ClassVar[int] = 3
    RELIABILITY_BEST_AVAILABLE: ClassVar[int] = 4
    DURABILITY_SYSTEM_DEFAULT: ClassVar[int] = 0
    DURABILITY_TRANSIENT_LOCAL: ClassVar[int] = 1
    DURABILITY_VOLATILE: ClassVar[int] = 2
    DURABILITY_UNKNOWN: ClassVar[int] = 3
    DURABILITY_BEST_AVAILABLE: ClassVar[int] = 4
    LIVELINESS_SYSTEM_DEFAULT: ClassVar[int] = 0
    LIVELINESS_AUTOMATIC: ClassVar[int] = 1
    LIVELINESS_MANUAL_BY_TOPIC: ClassVar[int] = 3
    LIVELINESS_UNKNOWN: ClassVar[int] = 4
    LIVELINESS_BEST_AVAILABLE: ClassVar[int] = 5
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/QoSProfile'


@dataclass
class rosgraph_msgs__msg__Service:
    """Class for rosgraph_msgs/msg/Service."""

    name: str
    request_type: rosgraph_msgs__msg__InterfaceType
    request_qos: rosgraph_msgs__msg__QoSProfile
    response_type: rosgraph_msgs__msg__InterfaceType
    response_qos: rosgraph_msgs__msg__QoSProfile
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/Service'


@dataclass
class rosgraph_msgs__msg__Topic:
    """Class for rosgraph_msgs/msg/Topic."""

    name: str
    type: rosgraph_msgs__msg__InterfaceType
    qos: rosgraph_msgs__msg__QoSProfile
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/Topic'


@dataclass
class rosgraph_msgs__msg__TypeHash:
    """Class for rosgraph_msgs/msg/TypeHash."""

    version: int
    value: np.ndarray[tuple[int, ...], np.dtype[np.uint8]]
    __msgtype__: ClassVar[str] = 'rosgraph_msgs/msg/TypeHash'
...
class sensor_msgs__msg__PointField:
    ...
    INT64: ClassVar[int] = 9
    UINT64: ClassVar[int] = 10
    BOOL: ClassVar[int] = 11
...
FIELDDEFS: Typesdict = {
    ...
    'geometry_msgs/msg/PolygonInstance': base.FIELDDEFS['geometry_msgs/msg/PolygonInstance'],
    'geometry_msgs/msg/PolygonInstanceStamped': base.FIELDDEFS[
    ...
    'geometry_msgs/msg/VelocityStamped': base.FIELDDEFS['geometry_msgs/msg/VelocityStamped'],
    ...
    'nav_msgs/msg/Goals': base.FIELDDEFS['nav_msgs/msg/Goals'],
    ...
    'rcl_interfaces/msg/LoggerLevel': base.FIELDDEFS['rcl_interfaces/msg/LoggerLevel'],
    ...
    'rcl_interfaces/msg/SetLoggerLevelsResult': base.FIELDDEFS[
    ...
    'service_msgs/msg/ServiceEventInfo': base.FIELDDEFS['service_msgs/msg/ServiceEventInfo'],
    ...
    'type_description_interfaces/msg/Field': base.FIELDDEFS[
        'type_description_interfaces/msg/Field'
    ],
    'type_description_interfaces/msg/FieldType': base.FIELDDEFS[
        'type_description_interfaces/msg/FieldType'
    ],
    'type_description_interfaces/msg/IndividualTypeDescription': base.FIELDDEFS[
        'type_description_interfaces/msg/IndividualTypeDescription'
    ],
    'type_description_interfaces/msg/KeyValue': base.FIELDDEFS[
        'type_description_interfaces/msg/KeyValue'
    ],
    'type_description_interfaces/msg/TypeDescription': base.FIELDDEFS[
        'type_description_interfaces/msg/TypeDescription'
    ],
    'type_description_interfaces/msg/TypeSource': base.FIELDDEFS[
    ...
    'rosbag2_interfaces/msg/MessagesLostEvent': (
        ...
        [
            ...
            (
                ...
                (T.SEQUENCE, ((T.NAME, 'rosbag2_interfaces/msg/MessagesLostEventTopicStat'), 0)),
            ),
        ],
    ),
    'rosbag2_interfaces/msg/MessagesLostEventTopicStat': (
        [],
        [
            ('topic_name', (T.BASE, ('string', 0))),
            ('messages_lost_in_transport', (T.BASE, ('uint64', 0))),
            ('messages_lost_in_recorder', (T.BASE, ('uint64', 0))),
        ],
    ),
    'rosgraph_msgs/msg/Action': (
        ...
        [
            ...
            ('send_goal', (T.NAME, 'rosgraph_msgs/msg/Service')),
            ('get_result', (T.NAME, 'rosgraph_msgs/msg/Service')),
            ('cancel_goal', (T.NAME, 'rosgraph_msgs/msg/Service')),
            ('feedback', (T.NAME, 'rosgraph_msgs/msg/Topic')),
            ('status', (T.NAME, 'rosgraph_msgs/msg/Topic')),
        ],
    ),
    'rosgraph_msgs/msg/Graph': (
        [],
        [
            ('nodes', (T.SEQUENCE, ((T.NAME, 'rosgraph_msgs/msg/Node'), 0))),
        ],
    ),
    'rosgraph_msgs/msg/InterfaceType': (
        ...
        [
            ('name', (T.BASE, ('string', 0))),
            ('hash', (T.NAME, 'rosgraph_msgs/msg/TypeHash')),
        ],
    ),
    'rosgraph_msgs/msg/Node': (
        ...
        [
            ('name', (T.BASE, ('string', 0))),
            ('parameters', (T.SEQUENCE, ((T.NAME, 'rcl_interfaces/msg/ParameterDescriptor'), 0))),
            ('parameter_values', (T.SEQUENCE, ((T.NAME, 'rcl_interfaces/msg/ParameterValue'), 0))),
            ('publishers', (T.SEQUENCE, ((T.NAME, 'rosgraph_msgs/msg/Topic'), 0))),
            ('subscriptions', (T.SEQUENCE, ((T.NAME, 'rosgraph_msgs/msg/Topic'), 0))),
            ('service_clients', (T.SEQUENCE, ((T.NAME, 'rosgraph_msgs/msg/Service'), 0))),
            ('service_servers', (T.SEQUENCE, ((T.NAME, 'rosgraph_msgs/msg/Service'), 0))),
            ('action_clients', (T.SEQUENCE, ((T.NAME, 'rosgraph_msgs/msg/Action'), 0))),
            ('action_servers', (T.SEQUENCE, ((T.NAME, 'rosgraph_msgs/msg/Action'), 0))),
        ],
    ),
    'rosgraph_msgs/msg/QoSProfile': (
        [
            ('HISTORY_SYSTEM_DEFAULT', 'uint8', 0),
            ('HISTORY_KEEP_LAST', 'uint8', 1),
            ('HISTORY_KEEP_ALL', 'uint8', 2),
            ('HISTORY_UNKNOWN', 'uint8', 3),
            ('RELIABILITY_SYSTEM_DEFAULT', 'uint8', 0),
            ('RELIABILITY_RELIABLE', 'uint8', 1),
            ('RELIABILITY_BEST_EFFORT', 'uint8', 2),
            ('RELIABILITY_UNKNOWN', 'uint8', 3),
            ('RELIABILITY_BEST_AVAILABLE', 'uint8', 4),
            ('DURABILITY_SYSTEM_DEFAULT', 'uint8', 0),
            ('DURABILITY_TRANSIENT_LOCAL', 'uint8', 1),
            ('DURABILITY_VOLATILE', 'uint8', 2),
            ('DURABILITY_UNKNOWN', 'uint8', 3),
            ('DURABILITY_BEST_AVAILABLE', 'uint8', 4),
            ('LIVELINESS_SYSTEM_DEFAULT', 'uint8', 0),
            ('LIVELINESS_AUTOMATIC', 'uint8', 1),
            ('LIVELINESS_MANUAL_BY_TOPIC', 'uint8', 3),
            ('LIVELINESS_UNKNOWN', 'uint8', 4),
            ('LIVELINESS_BEST_AVAILABLE', 'uint8', 5),
        ],
        [
            ('depth', (T.BASE, ('uint32', 0))),
            ('deadline', (T.NAME, 'builtin_interfaces/msg/Duration')),
            ('lifespan', (T.NAME, 'builtin_interfaces/msg/Duration')),
            ('history', (T.BASE, ('uint8', 0))),
            ('reliability', (T.BASE, ('uint8', 0))),
            ('durability', (T.BASE, ('uint8', 0))),
            ('liveliness', (T.BASE, ('uint8', 0))),
            ('liveliness_lease_duration', (T.NAME, 'builtin_interfaces/msg/Duration')),
        ],
    ),
    'rosgraph_msgs/msg/Service': (
        ...
        [
            ('name', (T.BASE, ('string', 0))),
            ('request_type', (T.NAME, 'rosgraph_msgs/msg/InterfaceType')),
            ('request_qos', (T.NAME, 'rosgraph_msgs/msg/QoSProfile')),
            ('response_type', (T.NAME, 'rosgraph_msgs/msg/InterfaceType')),
            ('response_qos', (T.NAME, 'rosgraph_msgs/msg/QoSProfile')),
        ],
    ),
    'rosgraph_msgs/msg/Topic': (
        ...
        [
            ('name', (T.BASE, ('string', 0))),
            ('type', (T.NAME, 'rosgraph_msgs/msg/InterfaceType')),
            ('qos', (T.NAME, 'rosgraph_msgs/msg/QoSProfile')),
        ],
    ),
    'rosgraph_msgs/msg/TypeHash': (
        [],
        [
            ('version', (T.BASE, ('uint8', 0))),
            ('value', (T.ARRAY, ((T.BASE, ('uint8', 0)), 32))),
        ],
    ),
