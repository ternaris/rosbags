...
libstatistics_collector__msg__DummyMessage = base.libstatistics_collector__msg__DummyMessage
...
FIELDDEFS: Typesdict = {
    ...
    'libstatistics_collector/msg/DummyMessage': base.FIELDDEFS[
